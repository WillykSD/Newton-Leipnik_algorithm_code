...
beta1 = -0.16  ;  beta2 = -1.6;  delta = 0.001;   eta = -64.0; omega=0.3;  % f0=.02;   

omegae = 50.0; omegaP = 282.843 ;    
epsilon = 1; theta = 0.6;   r1 = omegae^(epsilon-1);   r2 = omegaP^2/omegae^(1+theta);
