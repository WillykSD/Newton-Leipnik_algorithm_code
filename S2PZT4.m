...
%%%% Amplitude response Newton-Raphson method.   Ampl=f(epsilon)
...
omegae = 50.0; omegaP = 282.843 ;    
               theta = 0.6;   r1 =@(epsilon) (omegae^(epsilon-1));   r2 = omegaP^2/omegae^(1+theta);
...
% omega = 0.0:0.01:5.0;   % a0 = 0.0:0.00001:.05; omega = 0.0:0.005:5.0;
           %a01 = 0.130:0.00001:0.136;    a02 = 0.160:0.00001:0.166;    a0=[a01 a02];
a0 = 0.080:0.00001:0.14;
