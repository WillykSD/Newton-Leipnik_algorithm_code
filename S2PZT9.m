...
%%%% Amplitude response Newton-Raphson method.    Ampl=f(omega)
%%%% Ouput power vs frequency
...
epsilon = 1; theta = 0.9;   r1 = omegae^(epsilon-1);   r2 = omegaP^2/omegae^(1+theta);
...
a0 = 0.0:0.00001:0.3; omega=[omeg1a omeg2a];
...
figure(1);hold on
plot(A(1,:),P1max,'r','LineWidth', 3);

xlabel('\omega','FontSize',18)
ylabel('P_{1max}','FontSize',18)


figure(2);hold on
plot(A(1,:),P2max,'r','LineWidth', 3);


xlabel('\omega','FontSize',18)
ylabel('P_{2max}','FontSize',18)
