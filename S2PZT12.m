...
[XX,YY] = meshgrid(omega,ttheta);


figure(1);hold on
mesh(XX,YY,P1max); xlabel('\omega'); ylabel('\theta'); zlabel('P_{1max}');

figure(2);hold on
mesh(XX,YY,P2max); xlabel('\omega'); ylabel('\theta'); zlabel('P_{2max}');
